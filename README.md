...
- **对话驱动编码**：文本 + 图片输入，slash 命令面板，计划与工具调用卡片，支持 Agent Ask 多字段表单（单选、多选、推荐默认项与“其他”回答）
...
- **omp CLI**（已在 `v18.1.5` 上验证）— [oh-my-pi](https://github.com/can1357/oh-my-pi) 的命令行工具，需确保 `omp acp --help` 可正常执行。
