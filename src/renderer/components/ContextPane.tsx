      ...
      <div className="context-tabbar" role="tablist" aria-label="右侧栏标签">
        ...
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            <path
              d="M8 3.5h7l4 4V20a1.5 1.5 0 0 1-1.5 1.5h-11A1.5 1.5 0 0 1 5 20V5A1.5 1.5 0 0 1 6.5 3.5H8Z"
              stroke="currentColor"
              strokeWidth="1.8"
        ...
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            />
            <path
              d="m7.5 10 2.4 2-2.4 2M12.5 15h4"
              stroke="currentColor"
              strokeWidth="1.8"
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <div className="review-toolbar">
                    ...
                    <button
                      ...
                      className={
                        branchName === currentGitBranch
                          ? 'review-source-option active'
                          : 'review-source-option'
                      }
                      key={branchName}
                      role="menuitemradio"
            ...
            <div className="review-toolbar-actions">
              ...
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <path
                    d="M20 11a8 8 0 0 0-14.6-4.5L4 8M4 4v4h4M4 13a8 8 0 0 0 14.6 4.5L20 16M20 20v-4h-4"
                    stroke="currentColor"
                    strokeWidth="1.8"
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          {hasDiff ? (
            ...
            <div className="context-empty">
              <svg width="36" height="36" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                ...
                />
                <path
                  d="M14.5 3.5V8h4.5M8.5 12h7M8.5 16h5"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <strong>
                {selectedProject ? '当前来源下没有可展示的改动' : '请先选择 workspace'}
              </strong>
